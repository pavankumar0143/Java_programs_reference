...
public class EnocodeString {
	...
	public static  String encodeString(String s){
		...
		for(int i=0;i<s.length();i++){
			...
			case 0:res=res+(arr[((s.charAt(i)-'a')%25)+1]);break;
			
			case 1:res=res+(Character.toUpperCase(arr[((Character.toLowerCase(s.charAt(i))-'a')%25)+1]));break;
...
public static void main(String[] args) {
	System.out.println(encodeString("ZohoMail"));
}
}
